  ...
  return (
    <section className="mx-auto pt-20 w-11/12 text-center">
      ...
      <div className="flex justify-center items-center gap-4">
        <a href="https://play.google.com/store/games" target="_blank"><button className="p-6 btn"><img src={icoGPlay} /> Google Play</button></a>
        <a href="https://apps.apple.com/us/app/apple-store/" target="_blank"><button className="p-6 btn"><img src={icoAStore} />App Store</button></a>
      </div>
